...
/*	Put '<p><br></p>';*/
	...
	%End;
	%If "&_action" EQ "API_ALL DD JSON COMPARE" or "&_action" EQ "API_ALL DD JSON COMPARE WITH CODENAMES" %then
	%Do;
				*--- Read Dataset UniqueNames ---;
...
*/
	...
	%Do;
		...
		Put '<p><br></p>';
		Put '<INPUT TYPE=hidden NAME=_program VALUE="Source.ATM BRA PCA DD JSON CompareV01.sas">';
	...
	%Do;
		Put '<INPUT TYPE=submit VALUE=Return align="center">';
		Put '<p><br></p>';
		Put '<INPUT TYPE=hidden NAME=_program VALUE="Source.API_ALL DD JSON Compare with Codes V03.sas">';
		Put '<INPUT TYPE=hidden NAME=_service VALUE=' /
			"&_service"
			'>';
	    Put '<INPUT TYPE=hidden NAME=_debug VALUE=' /
	...
	%Do;
		Put '<INPUT TYPE=submit VALUE=Return align="center">';
		Put '<p><br></p>';
		Put '<INPUT TYPE=hidden NAME=_program VALUE="Source.API_ALL DD JSON Compare1V03.sas">';
		Put '<INPUT TYPE=hidden NAME=_service VALUE=' /
			"&_service"
			'>';
	    Put '<INPUT TYPE=hidden NAME=_debug VALUE=' /
	...
	%Do;
		Put '<INPUT TYPE=submit VALUE=Return align="center">';
		Put '<p><br></p>';
		Put '<INPUT TYPE=hidden NAME=_program VALUE="Source.BCA DD JSON CompareV02.sas">';
		Put '<INPUT TYPE=hidden NAME=_service VALUE=' /
			"&_service"
			'>';
	    Put '<INPUT TYPE=hidden NAME=_debug VALUE=' /
