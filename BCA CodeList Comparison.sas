...
*/
    ...
    infile 'C:\inetpub\wwwroot\sasweb\Data\Temp\V2_1\UML\BCA_CodeList_NonFees.csv'
...
data WORK.BCA_CODELIST_FEES;
    %let _EFIERR_ = 0; /* set the ERROR detection macro variable */
    infile 'C:\inetpub\wwwroot\sasweb\Data\Temp\V2_1\UML\BCA_CodeList_Fees.csv' 
	delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 TermStr = CRLF;
       informat CodelistName $50. ;
...
%Mend Import;
%Import(C:\inetpub\wwwroot\sasweb\Data\Temp\V2_1\UML\bcal_001_001_01DD.csv,BCA);
