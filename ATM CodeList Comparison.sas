...
Data Work.ATM_CodeList_Fees1(Drop = Description);
	Set Work.ATM_CodeList_Fees;
...
Data OBData.ATM_CodeList;
	Length CodelistName $ 50 CodeName CodeDescription $ 1000;
	Set Work.ATM_CodeList_Fees1(In=a Drop = Notes);
	Length Infile $ 8;
...
Proc Sort Data = OBData.ATM_CodeList(Keep = CodeName CodeListName CodeDescription
...
*--- Get data from API_ATM Data Dictionary data ---;
...
Data Work.API_ATM1(Drop = CodeListName Rename = (NewVar = CodeListName));
	Set Work.API_ATM;
...
Proc Sort Data = Work.API_ATM1
		Out = OBData.API_ATM2 NoDupKey;
	By CodeListName CodeName CodeDescription;
Run;

Data OBData.API_ATM2;
	Set OBData.API_ATM2;
...
Data OBData.ATM_Code_Compare Work.ATM_Code_Compare;
	Length Count 4 Hierarchy $ 1000 CodeListName $ 50 CodeName CodeDescription $ 1000;

	Merge OBData.API_ATM2(In=b Keep = Hierarchy CodeListName CodeName CodeDescription
	CodeListName_DD CodeName_DD CodeDescription_DD)

	OBData.ATM_CodeList(In=a Keep = CodeListName CodeName CodeDescription
