...
Proc Sort Data = OBData.PCA_CodeList(Keep = CodeName CodeListName CodeDescription
...
Proc Sort Data = Work.API_PCA1
		Out = OBData.API_PCA2 NoDupKey;
	By CodeListName CodeName CodeDescription;
Run;

Data OBData.API_PCA2;
	Set OBData.API_PCA2;
...
Data OBData.PCA_Code_Compare Work.PCA_Code_Compare;
	...
	Merge OBData.API_PCA2(In=b Keep = Hierarchy CodeListName CodeName CodeDescription
	CodeListName_DD CodeName_DD CodeDescription_DD)

	OBData.PCA_CodeList(In=a Keep = CodeListName CodeName CodeDescription
