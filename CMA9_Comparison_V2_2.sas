...
%Do;
/*	%If %sysfunc(fileexist(https://openapi.bankofireland.com/open-banking/v2.2/atms)) %Then*/
/*	%Do;*/
		%Main(https://openapi.bankofireland.com/open-banking/v2.2/atms,Bank_of_Ireland,ATM);
/*	%End;*/
	%Main(https://api.bankofscotland.co.uk/open-banking/v2.2/atms,Bank_of_Scotland,ATM);
	%Main(https://atlas.api.barclays/open-banking/v2.2/atms,Barclays,ATM);
	%Main(https://obp-data.danskebank.com/open-banking/v2.2/atms,Danske_Bank,ATM);
	%Main(https://openapi.firsttrustbank.co.uk/open-banking/v2.2/atms,First_Trust_Bank,ATM);
	%Main(https://api.halifax.co.uk/open-banking/v2.2/atms,Halifax,ATM);
	%Main(https://api.hsbc.com/open-banking/v2.2/atms,HSBC,ATM);
	%Main(https://api.lloydsbank.com/open-banking/v2.2/atms,Lloyds_Bank,ATM);
	%Main(https://openapi.nationwide.co.uk/open-banking/v2.2/atms,Nationwide,ATM);
	%Main(https://openapi.natwest.com/open-banking/v2.2/atms,Natwest,ATM);
	%Main(https://openapi.rbs.co.uk/open-banking/v2.2/atms,RBS,ATM);
	%Main(https://openbanking.santander.co.uk/sanuk/external/open-banking/v2.2/atms,Santander,ATM);
	%Main(https://openapi.ulsterbank.co.uk/open-banking/v2.2/atms,Ulster_Bank,ATM);
%End;
...
%Do;
/*	%If %sysfunc(fileexist(https://openapi.bankofireland.com/open-banking/v2.2/branches)) %Then */
/*	%Do;*/
	%Main(https://openapi.bankofireland.com/open-banking/v2.2/branches,Bank_of_Ireland,BCH);
/*	%End;*/
	%Main(https://api.bankofscotland.co.uk/open-banking/v2.2/branches,Bank_of_Scotland,BCH);
	%Main(https://atlas.api.barclays/open-banking/v2.2/branches,Barclays,BCH);
	%Main(https://obp-data.danskebank.com/open-banking/v2.2/branches,Danske_Bank,BCH);
	%Main(https://openapi.firsttrustbank.co.uk/open-banking/v2.2/branches,First_Trust_Bank,BCH);
	%Main(https://api.halifax.co.uk/open-banking/v2.2/branches,Halifax,BCH);
	%Main(https://api.hsbc.com/open-banking/v2.2/branches,HSBC,BCH);
	%Main(https://api.lloydsbank.com/open-banking/v2.2/branches,Lloyds_Bank,BCH);
	%Main(https://openapi.nationwide.co.uk/open-banking/v2.2/branches,Nationwide,BCH);
	%Main(https://openapi.natwest.com/open-banking/v2.2/branches,Natwest,BCH);
	%Main(https://openapi.rbs.co.uk/open-banking/v2.2/branches,RBS,BCH);
	%Main(https://openbanking.santander.co.uk/sanuk/external/open-banking/v2.2/branches,Santander,BCH);
	%Main(https://openapi.ulsterbank.co.uk/open-banking/v2.2/branches,Ulster_Bank,BCH);
%End;
...
%Do;
/*	%If %sysfunc(fileexist(https://openapi.bankofireland.com/open-banking/v2.2/personal-current-accounts)) %Then */
/*	%Do;*/
	%Main(https://openapi.bankofireland.com/open-banking/v2.2/personal-current-accounts,Bank_of_Ireland,PCA);
/*	%End;*/
	%Main(https://api.bankofscotland.co.uk/open-banking/v2.2/personal-current-accounts,Bank_of_Scotland,PCA);
	%Main(https://atlas.api.barclays/open-banking/v2.2/personal-current-accounts,Barclays,PCA);
	%Main(https://obp-data.danskebank.com/open-banking/v2.2/personal-current-accounts,Danske_Bank,PCA);
	%Main(https://openapi.firsttrustbank.co.uk/open-banking/v2.2/personal-current-accounts,First_Trust_Bank,PCA);
	%Main(https://api.halifax.co.uk/open-banking/v2.2/personal-current-accounts,Halifax,PCA);
	%Main(https://api.hsbc.com/open-banking/v2.2/personal-current-accounts,HSBC,PCA);
	%Main(https://api.lloydsbank.com/open-banking/v2.2/personal-current-accounts,Lloyds_Bank,PCA);
	%Main(https://openapi.nationwide.co.uk/open-banking/v2.2/personal-current-accounts,Nationwide,PCA);
	%Main(https://openapi.natwest.com/open-banking/v2.2/personal-current-accounts,Natwest,PCA);
	%Main(https://openapi.rbs.co.uk/open-banking/v2.2/personal-current-accounts,RBS,PCA);
	%Main(https://openbanking.santander.co.uk/sanuk/external/open-banking/v2.2/personal-current-accounts,Santander,PCA);
	%Main(https://openapi.ulsterbank.co.uk/open-banking/v2.2/personal-current-accounts,Ulster_Bank,PCA);
%End;
...
%Do;
/*%If %sysfunc(fileexist(https://openapi.bankofireland.com/open-banking/v2.2/business-current-accounts)) %Then */
/*%Do;*/
	%Main(https://openapi.bankofireland.com/open-banking/v2.2/business-current-accounts,Bank_of_Ireland,BCA);
/*%End;*/
	%Main(https://openapi.aibgb.co.uk/open-banking/v2.2/business-current-accounts,AIB_Group,BCA);
	%Main(https://api.bankofscotland.co.uk/open-banking/v2.2/business-current-accounts,Bank_of_Scotland,BCA);
	%Main(https://atlas.api.barclays/open-banking/v2.2/business-current-accounts,Barclays,BCA);
	%Main(https://obp-data.danskebank.com/open-banking/v2.2/business-current-accounts,Danske_Bank,BCA);
	%Main(https://openapi.firsttrustbank.co.uk/open-banking/v2.2/personal-current-accounts,First_Trust_Bank,BCA);
	%Main(https://api.hsbc.com/open-banking/v2.2/business-current-accounts,HSBC,BCA);
	%Main(https://api.lloydsbank.com/open-banking/v2.2/business-current-accounts,Lloyds_Bank,BCA);
	%Main(https://openapi.natwest.com/open-banking/v2.2/business-current-accounts,Natwest,BCA);
	%Main(https://openapi.rbs.co.uk/open-banking/v2.2/business-current-accounts,RBS,BCA);
	%Main(https://openbanking.santander.co.uk/sanuk/external/open-banking/v2.2/business-current-accounts,Santander,BCA);
	%Main(https://openapi.ulsterbank.co.uk/open-banking/v2.2/business-current-accounts,Ulster_Bank,BCA);
	%Main(https://openapi.coutts.com/open-banking/v2.2/business-current-accounts,Coutts,BCA);
	%Main(https://openapi.adambank.com/open-banking/v2.2/business-current-accounts,Adam_Bank,BCA);
%End;
...
%Do;
/*	%If %sysfunc(fileexist(https://openapi.bankofireland.com/open-banking/v2.2/unsecured-sme-loans)) %Then */
/*	%Do;*/
	%Main(https://openapi.bankofireland.com/open-banking/v2.2/unsecured-sme-loans,Bank_of_Ireland,SME);
/*	%End;*/
	%Main(https://openapi.aibgb.co.uk/open-banking/v2.2/unsecured-sme-loans,AIB_Group, SME);
	%Main(https://api.bankofscotland.co.uk/open-banking/v2.2/unsecured-sme-loans,Bank_of_Scotland,SME);
	%Main(https://atlas.api.barclays/open-banking/v2.2/unsecured-sme-loans,Barclays,SME);
	%Main(https://obp-data.danskebank.com/open-banking/v2.2/unsecured-sme-loans,Danske_Bank,SME);
	%Main(https://openapi.esmeloans.com/open-banking/v2.2/unsecured-sme-loans,ESME,SME);
	%Main(https://openapi.firsttrustbank.co.uk/open-banking/v2.2/unsecured-sme-loans,First_Trust_Bank,SME);
	%Main(http://localhost/sasweb/data/temp/od/firsttrust/v2_1/json/unsecured-sme-loans.json,First_Trust_Bank,SME);
	%Main(https://api.hsbc.com/open-banking/v2.2/unsecured-sme-loans,HSBC,SME);
	%Main(https://api.lloydsbank.com/open-banking/v2.2/unsecured-sme-loans,Lloyds_Bank,SME);
	%Main(https://openapi.natwest.com/open-banking/v2.2/unsecured-sme-loans,Natwest,SME);
	%Main(https://openapi.rbs.co.uk/open-banking/v2.2/unsecured-sme-loans,RBS,SME);
	%Main(https://openbanking.santander.co.uk/sanuk/external/open-banking/v2.2/unsecured-sme-loans,Santander,SME);
	%Main(https://openapi.ulsterbank.co.uk/open-banking/v2.2/unsecured-sme-loans,Ulster_Bank,SME);
%End;
...
%Do;
/*	%If %sysfunc(fileexist(https://openapi.bankofireland.com/open-banking/v2.2/commercial-credit-cards)) %Then */
/*	%Do;*/
	%Main(https://openapi.bankofireland.com/open-banking/v2.2/commercial-credit-cards,Bank_of_Ireland,CCC);
/*	%End;*/
	%Main(https://api.bankofscotland.co.uk/open-banking/v2.2/commercial-credit-cards,Bank_of_Scotland,CCC);
	%Main(https://atlas.api.barclays/open-banking/v2.2/commercial-credit-cards,Barclays,CCC);
	%Main(https://api.hsbc.com/open-banking/v2.2/commercial-credit-cards,HSBC,CCC);
	%Main(https://api.lloydsbank.com/open-banking/v2.2/commercial-credit-cards,Lloyds_Bank,CCC);
	%Main(https://openapi.natwest.com/open-banking/v2.2/commercial-credit-cards,Natwest,CCC);
	%Main(https://openapi.rbs.co.uk/open-banking/v2.2/commercial-credit-cards,RBS,CCC);
	%Main(https://openbanking.santander.co.uk/sanuk/external/open-banking/v2.2/commercial-credit-cards,Santander,CCC);
%End;
...
Data OBData.CMA9_&API;
	...
	If Data_Element = 'BrandName' Then 
	Do;
		_Record_ID + 1;
	End;
	Retain _Record_ID;
