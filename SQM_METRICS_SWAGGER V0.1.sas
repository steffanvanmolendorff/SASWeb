...
%Do;
	%Run_SQM(PCA_GB_AGG,PCA.GB.Agg,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ2" %Then
%Do;
	%Run_SQM(PCA_GB_FULL,PCA.GB.Full,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ3" %Then
%Do;
	%Run_SQM(PCA_NI_AGG,PCA.NI.Agg,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ4" %Then
%Do;
	%Run_SQM(PCA_NI_FULL,PCA.NI.Full,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ5" %Then
%Do;
	%Run_SQM(BCA_GB_AGG,BCA.GB.Agg,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ6" %Then
%Do;
	%Run_SQM(BCA_GB_FULL,BCA.GB.Full,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ7" %Then
%Do;
	%Run_SQM(BCA_NI_AGG,BCA.NI.Agg,SQM_Swagger1);
%End;

%If "&_APIName" EQ "SQ8" %Then
%Do;
	%Run_SQM(BCA_NI_FULL,BCA.NI.Full,SQM_Swagger1);
%End;
