...
=================================================================================================================;
*--- Create a macro variable to control Library paths within the code ---;
%Let Path = H:\STV\Open Banking\SAS\Data;
...
%let code_given =4/CQdktDryKWehGTsywJpPa3ai3xnUwUSYlzqJwnJEzEU;
